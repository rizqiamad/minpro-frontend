...
export default function ResponsiveFilter() {
  ...
  return (
    <>
      ...
      <div className={`${open ? 'inline-flex w-fit opacity-1 translate-x-0' : 'opacity-0 -translate-x-72'} ${hidden ? '' : 'hidden'} transition duration-300 flex-col fixed top-0 bottom-0 z-20 bg-white`}>
