...
export default function EventType({ setFieldValue }: EventTypeProps) {
  ...
  return (
    <>
      <h3 className="mb-5 ml-2 text-lg font-[500] text-black/50">What is your event type ?</h3>
      <ul className="grid w-full gap-6 xl:grid-cols-2">
        <li>
          ...
          <label htmlFor="free" className="inline-flex items-center justify-between w-full p-5 cursor-pointer border hover:border-lightBlue hover:text-lightBlue shadow-md peer-checked:text-lightBlue peer-checked:border-lightBlue">
            <div className="block">
              <div className="w-full text-lg font-semibold">FREE</div>
              <div className="w-full">Whole event is free</div>
            </div>
        ...
        <li>
          ...
          <label htmlFor="paid" className="inline-flex items-center justify-between w-full p-5 cursor-pointer border hover:border-lightBlue hover:text-lightBlue shadow-md peer-checked:text-lightBlue peer-checked:border-lightBlue">
            <div className="block">
